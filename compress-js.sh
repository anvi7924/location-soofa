...
Gist
 ...
 Watch 14
  Star 164
 Fork 49 dfsq/compressJS.sh
 Code  Issues 3  Pull requests 0  Projects 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathcompressJS.sh/compressjs.sh
1fe5b87  on Jan 4, 2015
 jm-begon Up-to-date processing
2 contributors @jaseclamp @dfsq
RawBlameHistory     
Executable File  78 lines (67 sloc)  2.18 KB
#!/bin/bash
